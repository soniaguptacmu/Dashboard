...
var _lastSelectedInstituteName;
var _lastSelectedInstituteId;

var tableMetaData = function(dataObject) {
	var schoolRows = [{
	            id: "1",
	            name: "Allegheny K-5"
	        }, {
	...
	if (dataObject.parentLevel === 0) {
	    return {
	        breadcrumb: [{
	            parentName: "Institutes",
	            parentLevel: 0,
	            parentId: '0'
	        }],
	        metrics: [{
	...
	else if (dataObject.parentLevel === 1) {
		_lastSelectedInstituteName = schoolRows[parseInt(dataObject.parentId) - 1].name;
		_lastSelectedInstituteId = dataObject.parentId;
	    return {
	        breadcrumb: [{
	            parentName: "Institutes",
	            parentLevel: 0,
	            ...
	            parentName: _lastSelectedInstituteName,
	            parentLevel: 1,
	            parentId: _lastSelectedInstituteId
	        }],
	        metrics: [{
	            displayName: "% exercise completed",
	            toolTip: "help text goes here"
	...
	else if (dataObject.parentLevel === 2) {
	    return {
	        breadcrumb: [{
	            parentName: "Institutes",
	            parentLevel: 0,
	            ...
	            parentName: classRows[parseInt(dataObject.parentId) - 1].name,
	            parentLevel: 1,
	        ...
	        rows: [{
	            id: "1",
	            name: "Dominic J. Pacheco"
	        }, {
	            id: "2",
	            name: "Henry L. Rodriguez"
	        }, {
	            id: "3",
	            name: "Mary L. Lanier"
	        }, {
	            ...
	            id: "5",
	            name: "Michael M. Bottomley"
	        },{
	            id: "6",
	            name: "Elisa J. Honore"
	        }, {
	            id: "7",
	            name: "Jonathan T. Smiley"
	        }, {
	            id: "8",
	            name: "Ella J. McKinney"
	        }, {
	            id: "9",
	            name: "Dorothy D. Lyons"
	        }, {
	            id: "10",
	            name: "Eunice J. Robinson"
	        }, {
	            id: "11",
	            name: "Richard B. Torres"
	        }, {
	            id: "12",
	            name: "Keith J. Cathey"
	        }, {
	            id: "13",
	            name: "Daisy J. Sylvester"
	        }, {
	            id: "14",
	            name: "David M. Myers"
	        }, {
	            id: "15",
	            name: "Quintiliano Conti"
	        },{
	            id: "16",
	            name: "Arcangela Bellucci"
	        }, {
	            id: "17",
	            name: "Principio Esposito"
	        }, {
	            id: "18",
	            name: "Max Braun"
	        }, {
	            id: "19",
	            name: "Brigitte Schultheiss"
	        }, {
	            id: "20",
	            name: "Anas Dijksma"
	        }]
...
var tableDataData = function(dataObject) {
	if (dataObject.parentLevel === 0)
    return {
        rows: [{
            id: "1",
    ...
    return {
        "topics": [{
            ...
            "children": [{
                ...
                "id": "1",
				"channelId": "1",
                "name": "Cival & Structural Engineering",
                "children": null
            },{
                "id": "1",
				"channelId": "1",
            ...
            "children": [{
                ...
                "id": "1",
				"channelId": "1",
                "name": "Genomics & Molecular Biology",
                "children": null
            },{
                "id": "1",
				"channelId": "1",
